...
workflow:
   step      skills
1. 赛题分析、RAG 检索与建模设计 - `2analysis-modeling` + `mathmodel-rag`
...
| 阶段 | Skill | 作用 | 主要产物 |
| --- | --- | --- | --- |
| 赛题分析与建模设计 | `2analysis-modeling` + `mathmodel-rag` | 先拆解题意，再按数学结构检索历史题、算法卡和策略卡，最后结合本题约束建立模型。 | `RAG_CONTEXT.md`, `ANALYSIS_MODELING_REPORT.md` |
